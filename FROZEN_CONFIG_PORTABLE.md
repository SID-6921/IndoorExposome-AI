...
The original ≥15-consecutive-minute sustained-duration rule cannot be evaluated from hourly averages. Adapted definition, applied identically to both datasets: **PM2.5 ≥35 µg/m³, sustained for ≥1 consecutive hour** (the finest resolvable duration at this resolution). Threshold unchanged at 35 µg/m³ (in the 100-homes pooled distribution this sits at ≈p95.7, slightly less extreme than LBNL's p97.5 but still a tail event, not renormalized to force a match).
